...
import org.apache.poi.xssf.usermodel.XSSFWorkbook;
	...
	public class Exceldata {
		...
		public static void main(String[] args) throws IOException {
			...
			public ArrayList<String> getData(String TestCases, String Data1) throws IOException {
				...
				FileInputStream fis = new FileInputStream("C:\\Users\\Menaga K\\Desktop\\demo.xlsx");
				...
				for(int i = 0; i < noofsheets; i++) {
					...
					if( workbook.getSheetName(i).equalsIgnoreCase("TestData")) {
						...
						while(rows.hasNext()) {
							Row r = rows.next();
							if(r.getCell(column).getStringCellValue().equalsIgnoreCase(Data1)){
